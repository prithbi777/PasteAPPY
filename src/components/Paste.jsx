  ...
  return (
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        {/* Search */}
        <div className="bg-black text-white font-bold w-full flex gap-3 px-4 py-2  rounded-[0.3rem] border border-[rgba(128,121,121,0.3)]  mt-6">
          <input
            type="search"
            placeholder="Search paste here..."
            className="bg-black text-white font-bold focus:outline-none w-full bg-transparent"
        ...
        {/* All Pastes */}
        <div className="bg-black text-white font-bold flex flex-col border border-[rgba(128,121,121,0.3)] py-4 rounded-[0.4rem]">
              ...
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  <div className="w-[50%] flex flex-col space-y-3">
                    ...
                    <p className="text-lg line-clamp-3 max-w-[80%] text-white font-bold">
                      {paste?.content}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-y-4 sm:items-end">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      <button
                        className="bg-green-500 text-white font-bold p-2 rounded-[0.2rem] hover:bg-transparent group hover:border-blue-500"
                      ...
                      <button
                        className="bg-red-600 text-white font-bold p-2 rounded-[0.2rem]   hover:bg-transparent group hover:border-pink-500"
