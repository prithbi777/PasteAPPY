      ...
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          <input
            ...
            className={`${
              pasteId ? "w-[80%]" : "w-[85%]"
            } text-white text-xl font-bold border border-input rounded-md p-2 bg-black`}
          />
          <button
            className="text-white  font-bold hover:bg-blue-800 focus:ring-4 focus:ring-blue-300  rounded-lg text-lg px-2 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
            onClick={createPaste}
          >
        ...
        >
          ...
          >
            ...
            >
              {/*Copy  button */}
              <button
                className={`flex justify-center items-center bg-blue-500 p-2 rounded-md  transition-all duration-300 ease-in-out group`}
                onClick={() => {
